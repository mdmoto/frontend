...
````
    server {
        listen       443 ssl;
        ssl_certificate "/etc/nginx/ssl/maollar.com.pem";
        ssl_certificate_key "/etc/nginx/ssl/maollar.com.key";
        ...
        server_name  im-api.maollar.com;
        location / {
