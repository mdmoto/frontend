          ...
          <div style="display:flex;position:relative">
            ...
            >
              <FormItem label="注册" prop="register">
                <Input type="text" v-model="point.register" placeholder="请输入注册赠送猫币"
                       style="width: 350px"/>
              </FormItem>
              <FormItem label="登陆" prop="login">
                <Input type="text" v-model="point.login" placeholder="请输入登陆赠送猫币"
                       style="width: 350px"/>
              </FormItem>
              <FormItem label="消费一元" prop="money">
                <Input type="text" v-model="point.money" placeholder="请输入猫币"
                       style="width: 350px"/>
              </FormItem>
              <FormItem>
                <Button type="primary" style="width: 100px;margin-right:5px" :loading="saveLoading"
